export const routeLoaders = {
  ...
  AdminUserWallet: () => import('../pages/admin/AdminUserWallet'),
...
const routeMatchers = [
  ...
  [/^\/admin\/users\/[^/]+\/transactions\/?$/, routeLoaders.AdminUserWallet],
  [/^\/admin\/user-transactions\/?$/, routeLoaders.AdminWallet],
